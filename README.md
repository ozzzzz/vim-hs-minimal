...
* Install [vim-plug](https://github.com/junegunn/vim-plug)
  Don't forget to add lines in `~/.vimrc` (here `coc` plugin added):
...
* Install [python language server](https://github.com/palantir/python-language-server)
